...
@Mod(modid = PNSilurianMod.MODID, name = PNSilurianMod.NAME, version = PNSilurianMod.VERSION, dependencies = "required-after:lepidodendron@[52.0,)")
public class PNSilurianMod {
    ...
    @Mod.Instance(MODID)
    public static PNSilurianMod instance;
    public ElementsPNSilurianMod elements = new ElementsPNSilurianMod();
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsPNSilurianMod.GuiHandler());
