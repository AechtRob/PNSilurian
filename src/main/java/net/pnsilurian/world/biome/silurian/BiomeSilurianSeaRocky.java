...
public class BiomeSilurianSeaRocky extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silurian_sea")
	public static final BiomeGenCustom biome = null;
	public BiomeSilurianSeaRocky(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeSilurian {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Silurian Rocky Ocean").setRainfall(0.5F).setBaseHeight(-1.4F).setHeightVariation(0.125F).setTemperature(2.25F));
			setRegistryName("lepidodendron:silurian_sea");
