...
public class BiomeSilurianCooksonia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silurian_cooksonia")
	public static final BiomeGenCustom biome = null;
	public BiomeSilurianCooksonia(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeSilurian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Silurian Cooksonia Fields").setRainfall(0.2F).setBaseHeight(-0.1F).setHeightVariation(0.08F).setTemperature(2.25F).setWaterColor(14745518));
			setRegistryName("lepidodendron:silurian_cooksonia");
		...
		public EnumBiomeTypeSilurian getBiomeType() {
			return EnumBiomeTypeSilurian.Cooksonia;
		}
	}
