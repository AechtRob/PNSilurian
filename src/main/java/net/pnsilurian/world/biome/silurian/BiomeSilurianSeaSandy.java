...
public class BiomeSilurianSeaSandy extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silurian_sea_sandy")
	public static final BiomeGenCustom biome = null;
	public BiomeSilurianSeaSandy(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeSilurian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Silurian Sandy Ocean").setRainfall(0.5F).setBaseHeight(-1.4F).setHeightVariation(0.08F).setTemperature(2.25F));
			setRegistryName("lepidodendron:silurian_sea_sandy");
