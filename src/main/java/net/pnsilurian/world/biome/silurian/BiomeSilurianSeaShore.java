...
public class BiomeSilurianSeaShore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silurian_sea_shore")
	public static final BiomeGenCustom biome = null;
	public BiomeSilurianSeaShore(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeSilurian {
		public BiomeGenCustom() {
			...
			setRegistryName("lepidodendron:silurian_sea_shore");
