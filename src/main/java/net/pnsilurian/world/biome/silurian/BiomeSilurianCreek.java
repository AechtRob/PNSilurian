...
public class BiomeSilurianCreek extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silurian_creek")
	public static final BiomeGenCustom biome = null;
	public BiomeSilurianCreek(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeSilurian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Silurian Creek").setRainfall(0.5F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(2.25F));
			setRegistryName("lepidodendron:silurian_creek");
