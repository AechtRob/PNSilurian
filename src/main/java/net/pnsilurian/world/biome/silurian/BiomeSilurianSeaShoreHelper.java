...
public class BiomeSilurianSeaShoreHelper extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silurian_sea_shore_helper")
	public static final BiomeGenCustom biome = null;
	public BiomeSilurianSeaShoreHelper(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
