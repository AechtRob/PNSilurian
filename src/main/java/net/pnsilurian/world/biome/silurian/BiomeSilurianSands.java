...
public class BiomeSilurianSands extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silurian_sands")
	public static final BiomeGenCustom biome = null;
	public BiomeSilurianSands(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeSilurian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Silurian Sands").setRainfall(0.5F).setBaseHeight(0.5F).setHeightVariation(0.22F).setTemperature(2.25F));
			setRegistryName("lepidodendron:silurian_sands");
