...
public class BiomeSilurianCreekCooksonia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silurian_creek_cooksonia")
	public static final BiomeGenCustom biome = null;
	public BiomeSilurianCreekCooksonia(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
