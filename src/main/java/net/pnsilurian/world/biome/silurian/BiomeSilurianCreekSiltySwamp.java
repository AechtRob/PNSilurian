...
public class BiomeSilurianCreekSiltySwamp extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silurian_creek_silty_swamp")
	public static final BiomeGenCustom biome = null;
	public BiomeSilurianCreekSiltySwamp(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
