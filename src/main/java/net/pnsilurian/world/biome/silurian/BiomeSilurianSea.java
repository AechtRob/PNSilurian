...
public class BiomeSilurianSea extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silurian_sea")
	public static final BiomeGenCustom biome = null;
	public BiomeSilurianSea(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeSilurian {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Silurian Sea").setRainfall(0.5F).setBaseHeight(-0.8F).setHeightVariation(0.05F).setTemperature(0.5F));
