...
public class BiomeSilurianBeach extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silurian_beach")
	public static final BiomeGenCustom biome = null;
	public BiomeSilurianBeach(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeSilurian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Silurian Beach").setRainfall(0.5F).setBaseHeight(0.0F).setHeightVariation(0.025F).setTemperature(2.25F));
			setRegistryName("lepidodendron:silurian_beach");
