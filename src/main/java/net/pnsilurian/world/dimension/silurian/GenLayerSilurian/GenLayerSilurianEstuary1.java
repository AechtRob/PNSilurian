...
public class GenLayerSilurianEstuary1 extends GenLayer
{
    ...
    public GenLayerSilurianEstuary1(long seed, GenLayer genLayer)
    {
        super(seed);
    ...
    private boolean isOcean(int biomeID) {
        if (biomeID == SILURIAN_OCEAN_ROCKY_ID || biomeID == SILURIAN_OCEAN_SHORE_ID
                || biomeID == SILURIAN_OCEAN_SANDY_ID || biomeID == SILURIAN_OCEAN_GARDEN_ID
                || biomeID == SILURIAN_OCEAN_CORAL_ID || biomeID == SILURIAN_REEF_ID
                || biomeID == SILURIAN_OCEAN_SHORE_HELPER_ID) {
            return true;
        }
        return false;
    }
