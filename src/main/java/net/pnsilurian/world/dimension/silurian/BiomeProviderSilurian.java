...
public class BiomeProviderSilurian extends BiomeProvider {
    ...
    protected BiomeProviderSilurian() {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = Lists.newArrayList(allowedBiomes);
    }

    public BiomeProviderSilurian(long seed, WorldType worldType, String options) {
        this();
        GenLayer[] agenlayer = GenLayerSilurian.initializeAllBiomeGenerators(seed, worldType, options);
        agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public BiomeProviderSilurian(long seed, WorldInfo info) {
