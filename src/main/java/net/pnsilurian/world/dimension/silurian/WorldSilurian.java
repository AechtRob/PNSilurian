...
import net.pnsilurian.world.dimension.silurian.BiomeProviderSilurian;
import net.pnsilurian.world.dimension.silurian.ChunkProviderSilurian;

import javax.annotation.Nullable;
import java.util.Random;

@ElementsLepidodendronMod.ModElement.Tag
public class WorldSilurian extends ElementsLepidodendronMod.ModElement {
    public static int DIMID = LepidodendronConfig.dimSilurian;
    public static final boolean NETHER_TYPE = false;
    @GameRegistry.ObjectHolder("lepidodendron:silurian_portal")
    public static final BlockCustomPortal portal = new BlockCustomPortal();
    public static DimensionType dtype;
    public WorldSilurian(ElementsLepidodendronMod instance) {
        super(instance, 1590);
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        if (DimensionManager.isDimensionRegistered(DIMID)) {
            ...
            System.err.println("Prehistoric Nature loading error! Dimension ID for the Silurian dimension is already registered by another mod: " + DIMID);
            return;
        }
        dtype = DimensionType.register("silurian", "_silurian", DIMID, WorldProviderMod.class, false);
    ...
    public static class WorldProviderMod extends WorldProvider {
        @Override
        public void init() {
            this.biomeProvider = new BiomeProviderSilurian(this.world.getSeed(), this.world.getWorldInfo());
        ...
        public Biome getBiomeForCoordsBody(final BlockPos pos, World worldIn)
        {
            ...
            {
                return worldIn.provider.getBiomeProvider().getBiome(pos, BiomeSilurianSeaShore.biome);
            }
        }
        ...
        public Biome getBiome(Chunk chunk, BlockPos pos, BiomeProvider provider)
        {
            ...
            if (k == 255)
            {
                ...
                Biome biome = world.isRemote ? BiomeSilurianSeaShore.biome : provider.getBiome(pos, BiomeSilurianSeaShore.biome);
                k = Biome.getIdForBiome(biome);
                chunk.getBiomeArray()[j << 4 | i] = (byte)(k & 255);
            }

            Biome biome1 = Biome.getBiome(k);
            return biome1 == null ? BiomeSilurianSeaShore.biome : biome1;
        }
        ...
        public Vec3d getFogColor(float par1, float par2) {
            ...
            //return new Vec3d(0.886274509804, 1, 0.752941176471);
            ...
            float f3 = 0.886274509804F;
            float f4 = 1F;
            float f5 = 0.752941176471F;
            f3 *= f2 * 0.94F + 0.06F;
            f4 *= f2 * 0.94F + 0.06F;
            f5 *= f2 * 0.91F + 0.09F;
        ...
        public IChunkGenerator createChunkGenerator() {
            return new ChunkProviderSilurian(this.world, this.world.getSeed() - DIMID);
        }
    ...
    public static class BlockCustomPortal extends BlockPortal {
        public BlockCustomPortal() {
            setHardness(-1.0F);
            setTranslationKey("pf_silurian_portal");
            setRegistryName("lepidodendron:silurian_portal");
            setLightLevel(0F);
        }
        ...
        public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
            ...
            for (int i = 0; i < 4; ++i)
            {
                ...
                Minecraft.getMinecraft().effectRenderer.addEffect(ParticlePNPortal.PortalParticleFactory.createParticle(world, d0, d1, d2, d3, d4, d5, 0.6836F, 0.7812F, 0.7695F));
            }
        }
            ...
            if (!worldIn.isRemote && !entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn instanceof EntityPlayerMP) {
                ...
                if (thePlayer.timeUntilPortal > 0) {
                    ...
                    if (thePlayer.dimension == DIMID) {
                        ...
                        ModTriggers.ENTER_SILURIAN.trigger((EntityPlayerMP)thePlayer);
                    }
    ...
    public static class GenLayerBiomesCustom extends GenLayer {
        ...
        private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:silurian_land")),
                Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:silurian_biome")),
